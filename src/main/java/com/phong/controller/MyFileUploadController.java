...
import com.phong.form.MyUploadForm;
...
public class MyFileUploadController {
    ...
    private String doUpload(HttpServletRequest request, Model model, @ModelAttribute("myUploadForm") MyUploadForm myUploadForm) {
